...
namespace PokeLab.Online
{
    ...
    {
        public int gachaVersion;
        public bool starterEligible;
        public GachaGroup[] starterGroups;
        public int starterSelected = -1;
        public bool ok;
        public string error;
    ...
    [Serializable]
    public sealed class GachaGroup { public GachaPull[] pulls; }

    [Serializable]
    public sealed class StarterGachaRequest { public int version = OnlineContract.Version; }

    [Serializable]
    public sealed class StarterChoiceRequest { public int version = OnlineContract.Version; public int selected; }
