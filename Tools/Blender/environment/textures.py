...
TOWN_CELLS = [
    ("plaster_cream", _c(p_plaster, 301, (0.90, 0.84, 0.70), (0.52, 0.46, 0.36))),
    ("plaster_blue",  _c(p_plaster, 302, (0.62, 0.74, 0.84), (0.34, 0.40, 0.48))),
    ("plaster_red",   _c(p_plaster, 303, (0.84, 0.56, 0.46), (0.44, 0.28, 0.24))),
    ("wood_beam",     _c(p_planks, 304, (0.40, 0.26, 0.16), (0.20, 0.12, 0.07), (0.54, 0.37, 0.22), 3, False, False)),
    ("roof_red",      _c(p_tiles, 305, (0.72, 0.28, 0.22), (0.42, 0.13, 0.11), (0.88, 0.44, 0.30), 12, 10)),
    ("roof_blue",     _c(p_tiles, 306, (0.26, 0.40, 0.62), (0.12, 0.20, 0.36), (0.42, 0.60, 0.82), 12, 10)),
    ("roof_green",    _c(p_tiles, 307, (0.24, 0.46, 0.34), (0.10, 0.24, 0.18), (0.40, 0.66, 0.46), 14, 8, False)),
    ("metal_roof",    _c(p_stripe, 308, (0.68, 0.74, 0.78), (0.50, 0.58, 0.64), 14)),
    ("window_glass",  _c(p_grad, 309, (0.16, 0.30, 0.40), (0.55, 0.76, 0.86), True, 0.0, 0.30)),
    ("door_wood",     _c(p_planks, 310, (0.44, 0.28, 0.16), (0.22, 0.13, 0.07), (0.60, 0.40, 0.22), 5, True, True)),
    ("paving",        _c(p_cobble, 311, (0.50, 0.48, 0.45), (0.72, 0.70, 0.65), (0.32, 0.30, 0.28), 54, 0.55)),
    ("stone_wall",    _c(p_cobble, 312, (0.46, 0.45, 0.43), (0.66, 0.64, 0.60), (0.28, 0.27, 0.26), 30, 0.1)),
    ("fence_wood",    _c(p_planks, 313, (0.50, 0.38, 0.24), (0.26, 0.18, 0.11), (0.68, 0.54, 0.34), 4, True, True)),
    ...
    ("trim_white",    _c(p_plaster, 316, (0.94, 0.93, 0.90), (0.60, 0.58, 0.55))),
]
...
PROPS_CELLS = [
    ...
    ("lab_panel",     _c(p_stripe, 413, (0.86, 0.88, 0.90), (0.72, 0.76, 0.80), 6, False)),
